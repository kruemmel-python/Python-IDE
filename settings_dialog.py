...
class SettingsDialog(QDialog):
    ...
    def load_current_settings(self, settings):
        """Lädt die aktuellen Einstellungen in die Dialogfelder."""
        for role, color in settings["colors"].items():
            if role in self.color_inputs:
                self.color_inputs[role].setText(color)
